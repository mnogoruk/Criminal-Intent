...
public class CrimeListFragment extends Fragment {
    ...
    private boolean mSubtitlesShown=false;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.show_subtitle:
                mSubtitlesShown = !mSubtitlesShown;
                updateSubtitles();
    ...
    private void updateSubtitles(){
        ...
        if(!mSubtitlesShown) subtitle = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedBundle) {
        ...
        if (savedBundle != null){
            mSubtitlesShown = savedBundle.getBoolean(SAVED_SUBTITLE_VISIBLE);
        }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean(SAVED_SUBTITLE_VISIBLE, mSubtitlesShown);
    }
